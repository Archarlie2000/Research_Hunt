...
# The final_df now contains the gene_id and TPM columns with appropriate prefixes.
...
Isoforms have been accounted for; reads with isoforms are mapped back to the expected counts through their percentages.
...
datatable(res0.05_ED, caption = "Deseq2 reuslt")
```
...
res0.05_DP <- as.data.frame(res0.05_DP) %>%
  filter(padj < 0.05)

datatable(res0.05_DP, caption = "Deseq2 reuslt")
```
...
process_data <- function(res0.05_ED, folder_name) {
  ...
  #          species    = "hsa",
  #          plot.mode  = "none",
  #          out.suffix = folder_name,
  #          out.dir    = output_folder) 
  
  result = as.data.frame(keggr)
  result <- result[,c(2,3,4,5,6,9)] %>% 
...
pathway_data <- function(res0.05_ED, folder_name, pathway_list) {
...
```{r message=FALSE, warning=FALSE}
result <- process_data(res0.05_ED, "ED")
datatable(result, caption = "ED")
result <- process_data(res0.05_DP, "DP")
datatable(result, caption = "DP")
result <- process_data(res0.05_EP, "EP")
datatable(result, caption = "EP")

```


# 5. Parrelle Comparison


### Insulin Signaling Pathway
ED
![ED](./pictures/hsa04910.ED_set.png)
DP
![DP](./pictures/hsa04910.DP_set.png)
EP
![EP](./pictures/hsa04910.EP_set.png)


### Estrogen Signaling Pathway
ED
![ED](./pictures/hsa04915.ED_set.png)
DP
![DP](./pictures/hsa04915.DP_set.png)
EP
![EP](./pictures/hsa04915.EP_set.png)

### Prolactin Signaling Pathway
ED
![ED](./pictures/hsa04917.ED_set.png)
DP
![DP](./pictures/hsa04917.DP_set.png)
EP
![EP](./pictures/hsa04917.EP_set.png)

### Insulin Resistance Pathway
ED
![ED](./pictures/hsa04931.ED_set.png)
DP
![DP](./pictures/hsa04931.DP_set.png)
EP
![EP](./pictures/hsa04931.EP_set.png)


```{r message=FALSE, warning=FALSE}

pathway_list = c("hsa04910","hsa04915", "hsa04917", "hsa04931")

# pathway_data(res0.05_ED, "ED_set", pathway_list)
# pathway_data(res0.05_DP, "DP_set", pathway_list)
# pathway_data(res0.05_EP, "EP_set", pathway_list)
